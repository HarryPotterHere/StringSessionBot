...
API_TEXT = """Hi, {}.
This is a Bot to generate String Session for your Telegram Account!
    ...
    try:
        otp = await bot.ask(
            chat.id, ("An OTP is sent to your phone number, "
                      ...
                      "Press /cancel to Cancel the Process."), timeout=300)
...
async def restart(_, msg: Message):
    await msg.reply("Bot has been Restarted!")
    HU_APP.restart()
...
I will give you `STRING_SESSION` for deploying your UserBot.
